    ...
    for Temp<'a, PM>
{
    fn read_temperature(&self) -> Result<(), ErrorCode> {
        self.power_manager.use_power_expecting::<_, Off>(|reg: Nrf5xTempRegister<Off>| {
            self.enable_interrupts(&reg);
            reg.event_datardy.write(EventDataReady::READY::CLEAR);
            let reg_result: Result<Nrf5xTempRegister<Reading>, PowerError<Nrf5xTempRegister<Off>>> = 
